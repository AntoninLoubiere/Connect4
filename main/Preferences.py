...
PREFERENCE_DIFFICULTY_DEPTH_LEVEL = 2
DEFAULT_DIFFICULTY_DEPTH_LEVEL = [1, 3, 4, 5, 6, 7]
DIFFICULTY_LEVEL_DEPTH_MIN = 1
DIFFICULTY_LEVEL_DEPTH_MAX = 15

PREFERENCE_WIN_DELAY = 3
DEFAULT_WIN_DELAY = 1000
DELAY_WIN_MIN = 0
DELAY_WIN_MAX = 10000

PREFERENCE_DIFFICULTY_ROUND_LEVEL = 4
DEFAULT_DIFFICULTY_ROUND_LEVEL = [100, 100, 50, 25, 1, 1]
DIFFICULTY_LEVEL_ROUND_MIN = 1
DIFFICULTY_LEVEL_ROUND_MAX = 200

DEFAULT_PREFERENCES = {
    PREFERENCE_DELAY: DEFAULT_DELAY,
    PREFERENCE_DIFFICULTY_DEPTH_LEVEL: DEFAULT_DIFFICULTY_DEPTH_LEVEL,
    PREFERENCE_WIN_DELAY: DEFAULT_WIN_DELAY,
    PREFERENCE_DIFFICULTY_ROUND_LEVEL: DEFAULT_DIFFICULTY_ROUND_LEVEL,
}
